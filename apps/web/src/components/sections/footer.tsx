...
export function SiteFooter() {
	return (
		<footer className="relative isolate border-border/60 border-t bg-background/60 pt-16 pb-8">
			<div
				aria-hidden
			...
			<div className="mx-auto w-full max-w-7xl px-4 sm:px-6">
				<div className="grid gap-10 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
					<div>
						...
						<p className="mt-4 max-w-sm text-muted-foreground text-sm leading-relaxed">
							...
							Protegemos empresas e pessoas contra ameaças digitais avançadas
							com metodologia moderna e resposta rápida.
						</p>
				...
				{/* Bottom bar */}
				<div className="mt-12 flex flex-col items-start justify-between gap-4 border-border/60 border-t pt-6 sm:flex-row sm:items-center">
				...
				<div className="mt-8 flex items-center justify-center">
					<div className="font-mono text-[10px] text-muted-foreground/50 uppercase tracking-[0.3em]">
